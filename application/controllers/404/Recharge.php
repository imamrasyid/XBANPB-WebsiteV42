...
Class Recharge extends CI_Controller
{
    ...
    function index()
    {
        $data['title'] = 'XBAN Origin || Data Voucher';
    ...
    {
        $data['title'] = 'XBAN Origin || Recharge History';
    ...
    function manual_recharge()
    {
        ...
        {
            $data['title'] = 'XBAN Origin || Recharge / Donation';
    ...
    function voucher()
    {
        ...
        if ($this->form_validation->run() === FALSE) 
        {
            $data['title'] = 'XBAN Origin || Recharge Voucher';
