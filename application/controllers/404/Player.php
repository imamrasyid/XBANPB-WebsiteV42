...
Class Player extends CI_Controller
{
    ...
    function index()
    {
        $data['title'] = 'XBAN Origin || Data Players';
    ...
    function view()
    {
        ...
        if ($_GET['id'] != null) 
        {
            $data['title'] = 'XBAN Origin || View Details';
    ...
    function inventory()
    {
        if (date('h') >= "00" && date('h') <= "23")
        {
            ...
            if ($_GET['id'] != null) 
            {
                $data['title'] = 'XBAN Origin || View Inventory';
    ...
    function banned()
    {
        ...
        if ($_GET['id'] != null) 
        {
            ...
            {
                $data['title'] = 'XBAN Origin || Banned Player';
    ...
    function create_player()
    {
        ...
        if ($valid->run() === FALSE) 
        {
            $data['title'] = 'XBAN Origin || Create Player';
        ...
        else 
        {
            ...
            $data = array(
                ...
                'password' => $this->lib_a->pass_encrypt($i->post('password')),
            ...
            if ($data) 
            {
                ...
                redirect(base_url('404/player/create_player'), 'refresh');
            }
            else 
            {
