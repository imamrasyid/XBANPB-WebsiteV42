...
Class Redeemcode extends CI_Controller
{
    ...
    function index()
    {
        $data['title'] = 'XBAN Origin || Data Redeem Code';
    ...
    function history()
    {
        $data['title'] = 'XBAN Origin || History Redeem Code';
    ...
    function redeemcode_item()
    {
        ...
        {
            $data['title'] = 'XBAN Origin || Create Redeem Code Item';
    ...
    function redeemcode_cash()
    {
        ...
        if ($this->form_validation->run() === FALSE)
        {
            $data['title'] = 'XBAN Origin || Create Redeem Code Cash';
