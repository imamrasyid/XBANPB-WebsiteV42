    ...
    <div class="splash-container">
        <div class="card bg-dark">
            <div class="card-header text-center bg-dark mb-0">
                <a href="#">
                    <img class="logo-img" src="<?php echo base_url() ?>assets/goodgames/assets/images/weblogo.png" alt="XBAN Origin Logo">
                </a>
                <span class="splash-description text-info mt-3">
                    Selamat Datang Di Moderator Panel XBAN Origin<br>
        ...
        <img src="<?php echo base_url() ?>base/dark-admin/assets/images/bg-main.jpg" class="background-image" alt="">
    </div>
    <!-- Optional JavaScript -->
