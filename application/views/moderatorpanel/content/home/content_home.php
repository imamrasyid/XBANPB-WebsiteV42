                                        ...
                                        <tbody class="text-center">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo base_url() ?>base/gamon/images/img_rank/<?php echo $row['rank'] ?>.gif" alt="<?php echo $row['rank'] ?>">
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-center">
                                                    <a href="<?php echo base_url('404/log') ?>" class="btn btn-outline-primary btn-small"><i class="fas fa-list-alt mr-2"></i>Lihat Semua Log</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
