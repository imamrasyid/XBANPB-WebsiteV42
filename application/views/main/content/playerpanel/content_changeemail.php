        ...
        <div class="row clearfix justify-content-center">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="default-form contact-form">
                    <?php echo form_open(base_url('playerpanel/changeemail'), '') ?>
                        ...
                        <div class="form-group">
                            <input type="text" name="old_email" value="<?php echo set_value('old_email') ?>" placeholder="Enter Your Old Email" autocomplete="off" autofocus required>
                        </div>
                        <div class="form-group">
                            <input type="text" name="new_mail" value="<?php echo set_value('new_email') ?>" placeholder="Enter Your New Email" autocomplete="off" autocomplete="off" required>
                        </div>
                        <div class="form-group">
