        ...
        <div class="row clearfix justify-content-center">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="default-form contact-form">
                    <?= form_open(base_url() . index_page() . '/playerpanel/changepassword', 'autocomplete="off"') ?>
                    ...
                    <div class="form-group">
                        <input type="password" name="old_password" value="<?= set_value('old_password') ?>" placeholder="Enter Your Old Password" minlength="4" maxlength="16" autofocus required>
                    </div>
                    <div class="form-group">
                        <input type="password" name="new_password" value="<?= set_value('new_password') ?>" placeholder="Enter Your New Password" minlength="4" maxlength="16" required>
                    </div>
                    <div class="form-group">
                        <input type="password" name="re_new_password" value="<?= set_value('re_new_password') ?>" placeholder="Enter Your New Password Again" minlength="4" maxlength="16" required>
                    </div>
                    <div class="form-group">
